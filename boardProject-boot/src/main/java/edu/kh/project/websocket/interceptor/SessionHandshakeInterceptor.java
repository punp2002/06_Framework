...
public class SessionHandshakeInterceptor implements HandshakeInterceptor{
	...
	public boolean beforeHandshake(ServerHttpRequest request, ServerHttpResponse response, WebSocketHandler wsHandler,
		...
		// ServerHttpRequest	 : HttpServerRequest의 부모 인터페이스
		// ServerHttpResponse	 : HttpServerHttpResponse 부모 인터페이스
		
		// request 가 참조하는 객체가 ServletServerHttpRequest 다운케스팅이 가능한가?
		// ServerHttpRequest -> ServletServerHttpRequest -> HttpServerRequest
	...
	// Handshake : 클라리언트 서버가 websockey 연결을 수립하고 위해
	// 				Http 프로토콜을 통해 수행하기는 초기 단계
	// 				-> 기존 HTTP 연결을 WebSock 연결로 변경.
